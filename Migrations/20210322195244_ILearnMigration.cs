...
{
    public partial class ILearnMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    text = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    start_date = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    end_date = table.Column<DateTime>(type: "DATETIME", nullable: true),
                    userId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    status = table.Column<string>(type: "NVARCHAR(50)", nullable: true),
                    subscriberEmail = table.Column<string>(type: "NVARCHAR(50)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Header = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    Body = table.Column<string>(type: "nvarchar(2000)", nullable: true),
